...
<html>
    ...
    <link rel="icon" type="image/x-icon" href="/Sad-Activity/picture/logo.png">
       ...
       <link rel="stylesheet" href="SaleManager.css">
       <link rel="preconnect" href="https://fonts.googleapis.com">
        <title>Home</title>
        
        <script src="SaleManager.html" defer></script>
        ...
        <div class="sidenav" id="a">
            <div class="companyname">Dexter Jamero</div>
                <div class="owner">Manager</div >
                   ...
                   <a href="staffacct.php" target="_self" class="nav"><i class="fa-solid fa-users"></i> Staff</a>
