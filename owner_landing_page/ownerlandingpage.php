...
<html>
    <head>
       ...
       <link rel="stylesheet" href="ownerlandingpage.css">
       <link rel="icon" type="image/x-icon" href="/Sad-Activity/picture/logo.png">
       <link rel="preconnect" href="https://fonts.googleapis.com">
        <title>Home</title>
        
        <script src="ownerlandingpage.js" defer></script>
    ...
    <body>
        ...
        <div class="sidenav" id="a">
            <div class="companyname">Dexter Jamero</div>
               ...
               <a href="/Sad-Activity/landingpage/landingpage.php" targe="_top"><i class="fa-solid fa-right-from-bracket"></i> Log out</a>
        </div>
            ...
            <div class="frame" src="" name="iframe">
             ...
             <?php include('header.php'); ?> 
                    <div class="busin-right">
                        ...
                        <div class="total_of_sale">
                            <label>Income:</label>
                            <label for=""> hi</label>
                        </div>
                        <div class="top_sale_product">
                            <p>Top Sales Product</p>
                        </div>
